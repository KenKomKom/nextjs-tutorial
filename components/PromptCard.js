    ...
    <div className='prompt_card'>
      <div className='flex justify-between items-start gap-5'>
        ...
        (<div className='mt-5 flex-center gap-4 border-t border-gray-100 pt-3'>
          <button onClick={handleEdit} className='font-inter text-sm green_gradient cursor-pointer'>Edit</button>
          <button onClick={handleDelete} className='font-inter text-sm orange_gradient cursor-pointer' >Delete</button>
        </div>)
        }
      </div>
    </div>
